...
public class NeoPixel extends SubsystemBase {
    ...
    private final AddressableLEDBuffer buffer = new AddressableLEDBuffer(48);
    ...
    public int ring = buffer.getLength()/4;
    public int segment = buffer.getLength()/2;
    public int total = buffer.getLength();
